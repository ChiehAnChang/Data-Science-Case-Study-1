...
from darts.models import NHiTSModel as DartsNHiTS
from darts.dataprocessing.transformers import Scaler
from darts.utils.likelihood_models import QuantileRegression

class NHITSModel(BasePM25Model):
    ...
    def fit(self, train_df: pd.DataFrame):
        ...
        self.model = DartsNHiTS(
            input_chunk_length=self.input_chunk_length, output_chunk_length=self.horizon,
