...
\centering
\vspace*{\fill}
{\Huge STAT 946: Case Studies in Data Science \par}
\vspace{1.5em}
{\LARGE Case Study 1: Air quality in Canada \par}
\vspace{1.5em}
...
It is published by the Government of Ontario.[@Government_of_Ontario_Air_Quality_Historical_Data_2024] We restrict the downloaded data to only contain the particular pollutant that we care about, which is PM2.5.
